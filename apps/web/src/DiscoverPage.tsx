...
const highlights = [
  { title: 'Mar de Olivos', eyebrow: 'PAISAJE', meta: '7,8 km · Fácil', position: 'left' },
  { title: 'Miradores de Mágina', eyebrow: 'SIERRA', meta: '10,4 km · Media', position: 'center' },
  { title: 'Caminos de Jimena', eyebrow: 'PUEBLOS', meta: '6,2 km · Fácil', position: 'right' },
] as const;
