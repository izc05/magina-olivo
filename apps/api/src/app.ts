...
import { registerAdminDelegatedRoutes } from './admin-delegated-routes.ts';
...
import { registerAdminTerritoryRoutes } from './admin-territory-routes.ts';
