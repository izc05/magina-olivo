...
export function DiscoverPage() {
  return (
    <main className="discover-territory-shell" id="main-content">
      ...
      <section className="discover-territory-section culture" aria-labelledby="culture-title"><div><p className="eyebrow">CULTURA Y TERRITORIO</p><h2 id="culture-title">Pueblos y experiencias</h2></div><a href="/descubre/pueblos">Ver todas</a></section>
